...
func TestNextDate(t *testing.T) {
	...
	tbl = []nextDate{
		...
		//Добавил несколько кейсов для проверки с високосными годами
		//Взял логику из 30й строки, если число месяца больше, чем дней в месяце,
		//то переходит на следующий месяц + остаток, а так же логику последний\предпоследний
		//день февраля
		{"20240310", "m -1 2", "20250228"},
		{"20240810", "m -2 2", "20250227"},
		{"20270310", "m -1 2", "20280229"},
		{"20250310", "m 29 2", "20260301"},
		{"20270310", "m 29 2", "20280229"},
	}
	check()
}
